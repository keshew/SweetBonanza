...
struct SweetLoseEarlyView: View {
    @StateObject var sweetLoseEarlyModel =  SweetLoseEarlyViewModel()
            ...
            ZStack {
                ...
                VStack {
                    ZStack {
                        Image(.loseEarly)
                            .resizable()
                            .frame(width: geometry.size.width * 0.875, height: geometry.size.height * 0.285)
                        ...
                        HStack(spacing: geometry.size.width * 0.013) {
                            NavigationLink(destination: SweetMenuView()) {
                                ZStack {
                                    Image(.backForButton)
                                        .resizable()
                                        .frame(width: geometry.size.width * 0.382, height: geometry.size.height * 0.061)
